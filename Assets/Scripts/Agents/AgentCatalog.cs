    ...
    public static class AgentCatalog
    {
        public static readonly List<AgentData> All = new()
        {
            new AgentData {
                ...
                statBias = "vitesse", color = ArtPalette.Hex("#FF5A36"),
            },
            new AgentData {
                ...
                statBias = "intelligence", color = ArtPalette.Hex("#6B4FA0"),
            },
            new AgentData {
                ...
                statBias = "force", color = ArtPalette.Hex("#46C0A0"),
            },
            new AgentData {
                ...
                statBias = "endurance", color = ArtPalette.Hex("#F5D76E"),
            },
        };
